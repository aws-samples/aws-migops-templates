...
## Task 4: Subtask 1: Identify and Engage Executive Sponsorhip (CIO/Deputy CIO)
#### Description
...
## Task 4: Subtask 2: Establish Meeting Cadence with Executive Sponsorship
#### Description
...
## Task 4: Subtask 3: Get Customer Commitment for work schedule for team.
#### Description
...
## Task 4: Subtask 4: Confirm office location and typical office hours
#### Description
...
## Task 6: Subtask 1: Import the Mobilize  Delivery Kits (DKs) to the approved tool
#### Description
Import  workstream delivery kits for use during the engagement.
## Task 6: Subtask 2: Establish a distribution list for the project team internally or externally accessible
#### Description
...
## Task 6: Subtask 3: Establish a stakeholder register Mobilize team page
#### Description
...
## Task 6: Subtask 4: Establish a communication plan
#### Description
...
## Task 6: Subtask 5: Establish a deliverables log
#### Description
Establish a deliverables log for the engagement.
#### Acceptance Criteria
•  Defined and approved deliverables catalog
## Task 6: Subtask 6: Confirm the governance process with the customer 
#### Description
...
## Task 6: Subtask 7: Identify and document key dates, milestones and  success criteria for project
#### Description
...
## Task 6: Subtask 8: Develop High Level Project plan
#### Description
Create a high-level project plan for the engagement.

#### Acceptance Criteria
•  Created high-level project plan
## Task 6: Subtask 9: Review and refine Project RACI document
#### Description
...
## Task 6: Subtask 10: Establish escalation matrix project and internal
#### Description
...
## Task 6: Subtask 11: Establish sprint schedule and meeting cadence  (standups, retrospectives, status)
#### Description
...
## Task 6: Subtask 12: Establish agree on Weekly Status  Reporting Steering Committee meetings
#### Description

...
## Task 3: Intake some work packages
#### Description
After setting up a CI/CD pipeline, start migration of work packages. Migration of multiple work packages can happen in parallel. Sometimes a small percent is done by AWS teams for calibration and the mass migration to be done by partners.
#### Acceptance Criteria
• Completed migration of work packages
## Task 4: Migrate app programs
#### Description
...
## Task 4: Subtask 1: Scale environments up or down
#### Description
...
## Task 4: Subtask 2: Modernize work package
#### Description

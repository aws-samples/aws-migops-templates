...
#### Acceptance Criteria
• Infrastructure cost after go-live
#### Acceptance Criteria
• Migration (labor)
#### Acceptance Criteria
• Project duration
...
#### Acceptance Criteria
• Completed portfolio-discovery report
...
#### Acceptance Criteria
• Identified pattern for mainframe migration to AWS
...
#### Acceptance Criteria
• Completed source code analysis for applications to be migrated. 
...
#### Acceptance Criteria
• A detailed plan to perform migrating environment discovery including the scope, prioritization, configuration, and data collection.
#### Acceptance Criteria
• Documented migrating environment business drivers such as accelerating innovation, reducing operational and infrastructure costs, and increasing operational resiliency.
#### Acceptance Criteria
• Captured the complete application and infrastructure metadata of the mainframe applications.
#### Acceptance Criteria
• A complete list of systems that will be part of the data collection.
#### Acceptance Criteria
• A plan to iteratively collect data requirements of migrating applications.
...
#### Acceptance Criteria
• An initial migration plan for mainframe migration to AWS. 
...
#### Acceptance Criteria
• Security, compliance, and resiliency strategies
...
AWS Mainframe Modernization
#### Acceptance Criteria
• Knowledge of the shared responsibility model in AWS for mainframe migrations.
...
#### Acceptance Criteria
• Defined a resilience strategy for mainframe migration to AWS.
## Task 2: Landing Zone
#### Description
...
AWS CloudTrail
#### Acceptance Criteria
• Completed Landing Zone for Mainframe migration
...
#### Acceptance Criteria
• Defined rollout plan for mainframe migration to AWS.
...
4)	DevOps training
#### Acceptance Criteria
• Defined plan for knowledge transfer and training for mainframe migration to AWS
...
#### Acceptance Criteria
• Preparation for the production environment is complete.
...
#### Acceptance Criteria
• Defined cutover plan for mainframe applications

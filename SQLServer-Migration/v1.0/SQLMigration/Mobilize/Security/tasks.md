...
#### Acceptance Criteria
• Learned Amazon Identity and Access Management (IAM)   
#### Acceptance Criteria
• Reviewed Amazon IAM policy language
#### Acceptance Criteria
• Understood when and where to use Amazon IAM
#### Acceptance Criteria
...
• Discovered identity federation options 
#### Acceptance Criteria
• Documented Amazon IAM discovery and analysis. This includes the following: 
a) Current state overview 
b) Policy 
c) Process 
d) Tools 
...
#### Description
Define the permanent credentials usage policy for Amazon IAM users. 

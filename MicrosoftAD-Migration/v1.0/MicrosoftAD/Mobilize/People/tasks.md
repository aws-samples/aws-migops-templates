...
#### Description
Set up the initial Cloud Center of Excellence (CCoE) structure. Ensure that leaders are  identified to lead the transformation for the AWS cloud migration journey.
#### Acceptance Criteria
...
## Task 3: Subtask 1: Identify Key  Leaders
#### Description
...
## Task 3: Subtask 2: Identify key topics to probe
#### Description
...
## Task 3: Subtask 3: Schedule Interviews with Key Leaders 
#### Description
...
#### Acceptance Criteria
• Gap analysis to call out any conflicts in leadership objectives
## Task 3: Subtask 4: Conduct leadership alignment assessment  interviews or administer leadership alignment survey
#### Description
Interview structure:  
...
#### Acceptance Criteria
•  Understand transformation goals
## Task 3: Subtask 5: Analyze interview and survey data and develop  leadership assessment feedback report that shows areas of alignment and gaps
#### Description
...
#### Acceptance Criteria
• Gap analysis to call out any conflicts in leadership objectives
## Task 3: Subtask 6: Share leadership assessment feedback report  with overall program sponsor
#### Description
...
## Task 3: Subtask 7: Work with program sponsor to determine next steps  for closing alignment gaps
#### Description
...
## Task 3: Subtask 8: Share leadership assessment feedback report with  leadership team
#### Description
...
## Task 3: Subtask 9: Produce final report and incorporate into  change strategy and plan
#### Description
...
## Task 4: Learning Development Strategy and Plan
#### Description
...
## Task 4: Subtask 1: Early Adopter  Identification and Readiness
#### Description
...
## Task 4: Subtask 2: Early Adopter Training
#### Description
...
## Task 4: Subtask 3: Conduct AWS Learning Needs Analysis LNA
#### Description
...
## Task 4: Subtask 4: Compile LNA Results
#### Description
Identify  the actionable results from the AWS LNA.
#### Acceptance Criteria
•  Identified LNA results
## Task 4: Subtask 5: Develop role-based training plans
#### Description
...
## Task 5: Subtask 1: AWS Consulting  Onboarding
#### Description
...
#### Acceptance Criteria
• Completion  of all onboarding steps for each consultant
## Task 5: Subtask 2: Backlog Grooming
#### Description
...
## Task 5: Subtask 3: Backlog Management
#### Description
...
## Task 5: Subtask 4: Complete Organizational Change Acceleration  RACI
#### Description
...
#### Acceptance Criteria
• A change acceleration RACI documented and signed off on
## Task 5: Subtask 5: Complete Organizational Change Acceleration/OCM  Charter
#### Description
...
## Task 5: Subtask 6: Establish cadence for People Workstream scrum  meetings
#### Description
...
## Task 5: Subtask 7: Align to weekly status and reporting
#### Description
...
## Task 5: Subtask 8: Develop first draft of People Metrics
#### Description
Set up a framework for measuring and publishing people-workstream progress.
## Task 5: Subtask 9: Complete Change Acceleration Deliverable  Tracker and Approval or SignOff Practice
#### Description
...
## Task 6: Organizational Change Management Strategy and  Plan
#### Description
...
## Task 7: Organizational Readiness
#### Description

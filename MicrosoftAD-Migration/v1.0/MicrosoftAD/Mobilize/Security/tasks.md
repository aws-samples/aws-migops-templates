...
## Task 1: Subtask 1: Conduct Deep  Dive on Identity and Access Management Workshop
#### Description
...
## Task 1: Subtask 2: Document Identity and Access Management Current  and Readiness State
#### Description
...
#### Acceptance Criteria
• Decided on roles and policies
## Task 1: Subtask 3: Conduct Identity and Access Management Security  Readiness State Gap Analysis and Story Development
#### Description
...
#### Acceptance Criteria
•  Completed gap analysis
## Task 1: Subtask 4: Define AWS root account usage policy
#### Description
...
## Task 1: Subtask 5: Define permanent credentials usage policy
#### Description
...
## Task 1: Subtask 6: Define multi account user authentication policy
#### Description
...
## Task 1: Subtask 7: Define base IAM roles and IAM policies naming  standard and definition
#### Description
...
## Task 1: Subtask 8: Define base preventative controls SCPs
#### Description
...
## Task 1: Subtask 9: Build base preventative controls SCPs
#### Description
Define base security control policies (SCPs).  For more information, see [GitHub](https://github.com/aws-samples/aws-migops-guidance/blob/main/General-Migration/v1.0/Security/Security-Artifacts/Identity-and-Access-Management/Authorization-Service-Control-Policies-(SCPs)-Design.md)
#### Tools
AWS Identity and Access Management (IAM)
...
## Task 1: Subtask 10: Build base IAM identities such as IAM roles and  IAM policies
#### Description
...
## Task 1: Subtask 11: Implement multi account AWS Console and API  access solution
#### Description
...
## Task 1: Subtask 12: Enforce MFA for AWS Console and  CLI usage during federation
#### Description
...
## Task 1: Subtask 13: Configure BreakGlass IAM User
#### Description
...
## Task 1: Subtask 14: Define periodic resource management cleanup  policy
#### Description
...
## Task 1: Subtask 15: Create Email DLs for AWS accounts alternative  contacts
#### Description
...
## Task 1: Subtask 16: Prepare AWS accounts for secure and efficient  operations
#### Description
...
## Task 2: Subtask 1: Conduct  Incident Response Workshop
#### Description
...
## Task 2: Subtask 2: Document Incident Response Current and  Readiness State
#### Description
...
d) Tools 
e) People
## Task 2: Subtask 3: Conduct Incident Response Security Readiness  State Gap Analysis and Story Development
#### Description
Conduct Incident Response Security Readiness  State Gap Analysis and Story Development
#### Acceptance Criteria
•  Completed gap analysis
## Task 2: Subtask 4: Define IR framework and playbooks
#### Description
...
## Task 2: Subtask 5: Develop a standard operating procedure for IR  activities
#### Description
...
## Task 3: Infrastructure Protection
#### Description
...
#### Acceptance Criteria
• Completed gap analysis 
## Task 3: Subtask 1: Conduct AWS  Network Security Design Workshop
#### Description
...
## Task 3: Subtask 2: Document Infrastructure Protection Current and  Readiness State
#### Description
...
d) Tools 
e) People
## Task 3: Subtask 3: Conduct Infrastructure Protection Security  Readiness State Gap Analysis and Story Development
#### Description
...
#### Acceptance Criteria
•  Completed gap analysis
## Task 3: Subtask 4: Define Security Group and NACL management
#### Description
...
## Task 3: Subtask 5: Define IDS and IPS strategy
#### Description
...
#### Acceptance Criteria
•  Defined IDS/IPS strategy
## Task 3: Subtask 6: Define Certificate Management Policy
#### Description
...
#### Acceptance Criteria
•  Defined a certificate management policy
## Task 3: Subtask 7: Define Secrets Management Policy
#### Description
...
## Task 3: Subtask 8: Define WAF rules management
#### Description
...
## Task 3: Subtask 9: Build infrastructure security controls
#### Description
...
#### Acceptance Criteria
• Completed gap  analysis  
## Task 4: Subtask 1: Conduct Logging  and Alerting Design Workshop
#### Description
...
## Task 4: Subtask 2: Document Logging and Monitoring Current and  Readiness State
#### Description
...
d) Tools 
e) People
## Task 4: Subtask 3: Conduct Logging and Monitoring Security  Readiness State Gap Analysis and Story Development
#### Description
...
#### Acceptance Criteria
•  Completed gap analysis
## Task 4: Subtask 4: Establish logging pattern and strategy
#### Description
...
## Task 4: Subtask 5: Define required service logs for ingestion
#### Description
...
## Task 4: Subtask 6: Establish long-term retention logging strategy
#### Description
...
## Task 4: Subtask 7: Define required monitoring services to enable
#### Description
...
## Task 4: Subtask 8: Define a base set of  detective controls to enable
#### Description
...
## Task 4: Subtask 9: Build a base set of detective controls to  enable
#### Description
Define a base set of detective controls. For more information, see [GitHub](https://github.com/aws-samples/aws-migops-guidance/blob/main/General-Migration/v1.0/Security/Security-Artifacts/Logging-and-Monitoring/Monitoring-Detective-Controls-Design.md)
#### Tools
AWS Config  Rules
...
b) access keys  
c) unused privileges to enforce least privilege
## Task 4: Subtask 10: Build required monitoring services
#### Description
